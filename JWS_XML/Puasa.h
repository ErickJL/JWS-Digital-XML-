...
//    Serial.println("tidak dikerjakan");
  ...
  Disp.drawRect(0,3,31,3);
  Disp.drawRect(0,15,31,15);
  Disp.setFont(Font4x6ali);
  Disp.drawText(4, -1, buff);
  if(Hjr_Month == 9){
    sprintf(msg,"JANGAN LUPA NIAT PUASA %s",namaPuasa[ty_puasa-1]);
  }else
