//updateJWS(79), membuatDataAwal(111), loadJwsConfig(201), loadDispConfig(254), loadAdminConfig(286), reset_Par(324), bacaParameter(334), JadwalSholat(371)
//TanggalHijriah(383), UpdateWaktu(412), XMLWaktu(463), XMLDataJWS(491), XMLDataAdmin(550)
...
void membuatDataAwal() {
  ...
  dataawal = "{\"latitude\":\"-8.79775\",\"longitude\":\"115.2202\",\"zonawaktu\":\"8\",\"hilal\":\"2\",\"ssid\":\"JWS Al-Furqon\",\"password\":\"12345678\",\"batastombol\":\"100\"}";
  error = deserializeJson(doc, dataawal);
