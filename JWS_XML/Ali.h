//serialWithDelay(14), runAdzanSingle(18), drawMasjid(112), anim_DT(135), identitas(191), dispTanggal(229), dispInfo(274), runAzzan(320), disableAzzan(383)
//check_azzan(410), kedip(454), dispJadwal(470), dispJadwal2(518), waktuSholatNow(608)
...
void identitas(uint8_t& next) {
  ...
  char msg[54];
  sprintf(msg, "JAM WAKTU SHOLAT DIGITAL");
